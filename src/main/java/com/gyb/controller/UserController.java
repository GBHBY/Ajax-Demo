...
public class UserController {
    ...
    public String testAjax(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws IOException {
...
//        转json
        String s = JSON.toJSONString(allName);
        out.write(s);
        out.close();
        return "demo";
    }
